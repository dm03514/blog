...
[ValueStream](https://github.com/ImpactInsights/valuestream) now supports exporting metrics to [Prometheus](https://prometheus.io/) as well as [Jaeger/ElasticSearch](https://www.jaegertracing.io/docs/1.11/)!  [ValueStream](https://github.com/ImpactInsights/valuestream) provides [DevOps](https://cloud.google.com/blog/products/devops-sre/the-2019-accelerate-state-of-devops-elite-performance-productivity-and-scaling) and Software Engineering metrics in a free easy to operate service and we're excited to announce support for Prometheus through [OpenCensus](https://opencensus.io/exporters/supported-exporters/go/).  We're also shipping a [Grafana](https://grafana.com/) dashboard to allow teams to begin to consume these critical metrics and get a pulse on organizational deployment performance.
